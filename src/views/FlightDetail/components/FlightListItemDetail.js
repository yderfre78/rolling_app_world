  ...
  return (
    <>
      {segments?.map((segment, index) => {
        ...
        const durationsDaysDeparture = moment(segment.departure.at).day();
        const durationsDaysArrival = moment(segment.arrival.at).day();
        ...
        if (durationsDaysDeparture < durationsDaysArrival) {
          const restHoursDeparture = 24 - durationHoursDeparture;
          const restHoursArrive = 24 - durationHoursArrival;
          const hoursTotal = restHoursDeparture + restHoursArrive;
